...
I am partial to the use of "syncme" but I will reference it as compiled_binary_name
(Note, you should not use quotes in your name and it should contain no spaces)

 Compile with:
 gcc syncme.c -o compiled_binary_name
...
int main() {
    setuid(0);
    system("sudo ntpdate -s us.pool.ntp.org");
    return 0;
}
